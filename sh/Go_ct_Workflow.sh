...
# Use leadmine_utils.sh and custom LeadMine API client.
${cwd}/sh/Go_pubmed_NER_chem.sh \
	>${cwd}/data/Go_pubmed_NER_chem-${DATE}.log
#
###
# NextMove Leadmine:
# (1) Chemical NER on AACT drug intervention names.
# (2) Disease/phenotype NER on AACT descriptions, using custom dictionaries.
${cwd}/sh/Go_ct_NER_chem.sh \
	>${cwd}/data/Go_ct_NER_chem-${DATE}.log
